...
;(function(){
    ...
    function getUserAddScore(button,flag){
        ...
        $.ajax({
            url: '<?php e::url('/leader/user/addscore/');?>?user=<?php echo($title)?>&date='+date_addstore,
            type:'post',
            dataType:'json',
            success:function(data){
                ...
                if(len>0){
                    ...
                    data_len = $.parseJSON(data[len-1]).hasOwnProperty('lastmonth')? (len-1):len;
    ...
    function getUserSubmited(button,flag){
        ...
        $.ajax({
            url: '<?php e::url('/leader/user/submited/');?>?user=<?php echo($title)?>&date='+date_submited,
            type:'post',
            dataType:'json',
            success:function(data){
                 var data_x = new Array();//时间轴坐标
