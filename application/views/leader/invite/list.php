<ul class="pagination problem-pagination">
    <?php for($i = 1; $i <= $pages; $i++): ?>
        <li<?php if($i == Request::$current->param('id')):?> class="active"<?php endif;?>><a href="<?php e::url("/leader/invite/index/{$i}");?>"><?php echo($i);?></a></li>
    <?php endfor;?>
</ul>
...
<td><a class="edit-link" href="<?php e::url("/leader/problem/edit/{$p->group_id}");?>"><?php echo(__('admin.problem.list.edit')); ?></a></td>
<td><a class="edit-link" href="<?php e::url("/leader/problem/edit/{$p->group_id}");?>"><?php echo(__('delete')); ?></a></td>
<?php endforeach;?>
</table>
