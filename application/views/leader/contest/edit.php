...
<form class="form-horizontal" method="POST" action="<?php e::url("/leader/contest/edit/{$contest->contest_id}"); ?>">
    <fieldset>
...
//                    alert($(v).attr('id'));
                    ...
                    $(function () {
                        ...
                        var datasource = function(request, response){
                            ...
                            $.getJSON('<?php e::url("/leader/problem/search"); ?>', request, function(data, status, xhr){
                                cache[ term ] = data;
                                response( data );
                            })
                        }
